...
namespace Personal_Tracking
{
    public partial class FrmSalaryList : Form
    {
        ...
        private void btnUpdate_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Please select salary an table");
            }
            else
            {
        ...
        private void FrmSalaryList_Load(object sender, EventArgs e)
        {
            ...
            {
                dto.Salaries = dto.Salaries.Where(p => p.EmployeeID == UserStatic.EmployeeID).ToList();
            }
            ...
            if (!UserStatic.isAdmin)
            {
                btnDelete.Hide();
                btnUpdate.Hide();
                btnNew.Location = new Point(252, 24);
                btnClose.Location = new Point(404, 24);
                pnlForAdmin.Hide();
            }
        ...
        {
            DialogResult result = MessageBox.Show("Are you sure to delete salary", "Waring!", MessageBoxButtons.YesNo);
